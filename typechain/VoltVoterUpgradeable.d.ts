...
interface VoltVoterUpgradeableInterface extends ethers.utils.Interface {
  functions: {
...
export class VoltVoterUpgradeable extends BaseContract {
  ...
  interface: VoltVoterUpgradeableInterface;
